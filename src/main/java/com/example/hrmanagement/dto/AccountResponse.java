...
public class AccountResponse {
    ...
    public static AccountResponse fromEntity(Employee employee) {
        ...
        response.setUserId(employee.getUser() != null ? employee.getUser().getUserId() : null);
        response.setUsername(employee.getUser() != null ? employee.getUser().getUsername() : null);
        response.setRole(employee.getUser() != null ? employee.getUser().getRole().name() : null);
